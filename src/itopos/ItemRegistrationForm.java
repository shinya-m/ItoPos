...
public class ItemRegistrationForm extends JDialog{
	...
	public ItemRegistrationForm(final ItemDao dao,Frame owner,final String bcode) {
		...
		thisLayout.setVerticalGroup(thisLayout.createSequentialGroup()
			...
			.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
			    .addComponent(name, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
			...
			.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
			    .addComponent(type_box, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
			...
			.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
			    .addComponent(num, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
			    .addComponent(num_label, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
			.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
			    .addComponent(sold_cost, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		thisLayout.setHorizontalGroup(thisLayout.createSequentialGroup()
			...
			.addGroup(thisLayout.createParallelGroup()
			    .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
			        .addGroup(thisLayout.createParallelGroup()
			            .addComponent(num_label, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE)
			            .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
			                .addComponent(type, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
			                .addGap(24))
			            .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
			    ...
			    .addGroup(thisLayout.createSequentialGroup()
			        ...
			        .addGroup(thisLayout.createParallelGroup()
			            ...
			            .addGroup(thisLayout.createSequentialGroup()
			                .addComponent(type_box, GroupLayout.PREFERRED_SIZE, 203, GroupLayout.PREFERRED_SIZE))
			            .addGroup(thisLayout.createSequentialGroup()
